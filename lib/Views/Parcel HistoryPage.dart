...
class _ParcelHistoryState extends State<ParcelHistory> {
  ...
  getParcelListApi(String status) async {
    setState(() {
      isLoading = true;
    });
    ...
    request.fields.addAll({'user_id': userId ?? "323", 'status': status});
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  // Text(
                                                  //   "Date : ${DateFormat('dd/MM/yyyy').format( DateFormat('dd-MM-yyyy').parse(parcelDataList?.data?[index].parcelDetails?.first.onDate ?? ""))}",
                                                  ...
                                                  SizedBox(
                                                    width: 100,
                                                    child: Text(
                                                        "${DateFormat('dd/MM/yyyy').format(DateFormat('dd-MMM-yyyy').parse(parcelDataList?.data?[index].parcelDetails?.first.onDate ?? ""))}",
                                                        overflow:
                                                        TextOverflow
                                                            .fade,
                                                        maxLines: 3),
