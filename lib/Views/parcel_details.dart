...
class _ParcelDetailsViewState extends State<ParcelDetailsView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: colors.primary,
        title: Text(
          getTranslated(context, "Parcel Details") + "fj",
          //  'Parcel Details'
        ),
      ),
      body: FutureBuilder(
        future: my,
        builder: (context,s) {
          return s.connectionState==ConnectionState.waiting?Center(child: CircularProgressIndicator(),) :Container(
              decoration: BoxDecoration(
                                            ...
                                            ? Row(
                                                ...
                                                children: [
                                                  ...
                                                  OTPField(
                                                    ...
                                                    onTap: () {
                                                      orderPickedOrCompleteByOtp(
                                                          _otpController.text, '3');
                                                    },
                                                  ),
                                                  CircleAvatar(
                                                      backgroundColor:
  ...
  Future<void> scanQR() async {
    ...
    try {
      ...
      barcodeScanRes =
          getTranslated(context, "Failed to get platform version.");
  ...
  void orderPickedOrCompleteByOtp(String otp, String status) async {
    if (otp.isEmpty) {
      Fluttertoast.showToast(msg: getTranslated(context, "please enter otp")
          //   'please enter otp'
          );
      ...
      if (response.statusCode == 200) {
        ...
        if (finalResult['status']) {
          if (status == '3') {
            Fluttertoast.showToast(
                msg: getTranslated(context, "Order Picked Successfully")
            ...
            Fluttertoast.showToast(
                msg: getTranslated(
                    context, "Order has been delivered successfully")
        ...
        builder: (BuildContext context) {
          return Container(
            ...
            child: AlertDialog(
              ...
              title: Text(
                getTranslated(
                    context, "Are you sure you want to Cencel this parcel?"),
                //  "Are you sure you want to Cencel this parcel?",
                textAlign: TextAlign.center,
              ),
              content: Text(
                getTranslated(
                    context, "If yes, then you will be charged a penalty"),
    ...
    return SizedBox(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          labelText: getTranslated(context, "Enter OTP"),
          // 'Enter OTP',
        ),
      ),
    );
