...
class _AddAmountState extends State<AddAmount> {
  ...
  onSuccessAddMoney() async {
    ...
    var request = http.Request(
        'POST', Uri.parse('${Urls.baseUrl}Payment/driver_add_money_to_wallet'));
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const MyWallet()));
                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      Center(
                          child: Text(
                        getTranslated(context, "Add money to wallet"),
                        // "Add money to wallet",
                        style: TextStyle(
                      ...
                      Text(
                        widget.walletBalance.toString() == "null"
                            ? "₹ 0"
