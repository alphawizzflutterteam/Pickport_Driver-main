...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xFF0F368C);
  static const Color secondary = Color(0xff66CC00);
  static const Color text = Color(0xff757575);
  static const Color text1 = Color(0xff000000);
  static const Color text2 = Color(0xffF5FAFD);
  ...
  static const Color grad1Color = Color(0xFFDF4E17);
  static const Color grad2Color = Color(0xffE2B517);
  static const Color lightWhite2 = Color(0xffEEF2F3);
  static const Color background= Color(0xFFF5FAFD);
  static Color splashcolor = Color(0xFFDDEDFA);
  static Color backColor = Colors.black;

  static const Color yellow = Color(0xfffdd901);

  static const Color red = Color(0xFFDF4E17);
